#!/usr/bin/env python3
"""
YOLO Cache Generation Script
===========================

This script generates cache files from YOLOv3/Gaussian YOLOv3 checkpoints for conformal prediction.
...
IMG_SIZE = 416              # Input image size for YOLOv3
